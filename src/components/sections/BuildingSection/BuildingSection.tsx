...
const SPECS = [
  ...
  { label: '준공연도',   value: '2004년 1월 14일' },
  { label: '총 면적',    value: '68.44㎡' },
  { label: '주차',       value: '옥내 기계식 18대 (197.34㎡) · 옥외 1대 (11.5㎡)' },
  { label: '엘리베이터', value: '2대' },
]
      ...
      <div className={styles.container}>
        ...
        <div className={styles.overview}>
          ...
          <AnimateIn className={styles.specsWrap} activeClassName={styles.inView} threshold={0.1}>
            ...
            <PhoneLink className={styles.cta} location="building_section">
