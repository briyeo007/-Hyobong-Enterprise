...
const FACILITIES = [
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.81 19.79 19.79 0 01.08 2.18 2 2 0 012.07 0h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.18 6.18l.41-.41a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/>
      </svg>
    ),
    label: '관리실',
    desc: '평일 상주 관리',
      ...
      <div className={styles.container}>
        ...
        <div className={styles.facilitiesWrap}>
          ...
          <div className={styles.facilitiesGrid}>
            {FACILITIES.map((f) => (
              <div key={f.label} className={styles.facilityCard}>
