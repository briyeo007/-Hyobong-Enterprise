...
export const PROPERTIES: Property[] = [
  {
    ...
    floor: '1층 102호',
    summary: '사무실 임대',
    area: { contract: 66, actual: 44 },
    deposit: '5,000만원',
    rent: '400만원',
    maintenance: '100만원',
    urgency: '✔ 즉시 입주 가능',
    tags: ['즉시 입주 가능', '무료주차 1대'],
    detailSpecs: [
      { label: '용도', value: '사무실' },
  ...
  },
  {
    ...
    maintenance: '200만원',
    urgency: '✔ 즉시 입주 가능',
    tags: ['즉시 입주 가능', '전층 단독 사용', '무료주차 2대'],
    detailSpecs: [
      { label: '용도', value: '사무실 (전층 단독 사용)' },
      { label: '주차', value: '무료 2대 제공' },
      { label: '엘리베이터', value: '완비' },
      { label: '관리비 포함', value: '전기·수도·청소·경비' },
      { label: '관리 형태', value: '전문 관리팀 상주' },
    ],
  ...
  return (
    <section id="property" className={styles.section}>
      <div className={styles.container}>
        ...
        <PhoneLink className={styles.phoneCta} location="property_section_notice">
        ...
        <div className={styles.grid}>
          {PROPERTIES.map((p, idx) => (
            ...
            >
              ...
              <PhoneLink className={styles.cta} location="property_section_card">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z"/>
                </svg>
                문의하기 · 02-3473-6651
